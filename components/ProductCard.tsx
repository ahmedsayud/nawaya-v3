...
const ProductCard: React.FC<ProductCardProps> = ({ product, onAddToCart, isInCart = false }) => {
  ...
  const showAddedState = justAdded || isInCart;
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <button
            ...
            disabled={isAdding}
            className={`flex items-center gap-x-2 font-bold py-2 px-4 rounded-lg transition-all duration-300 transform shadow-lg text-sm border ${showAddedState
          ...
          >
            {isAdding ? (
              ...
              <>
                ...
                <span>{isInCart ? 'تمت الإضافة' : 'تمت الإضافة!'}</span>
              </>
            ) : (
              <>
